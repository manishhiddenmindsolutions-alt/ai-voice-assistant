...
const RegisterPage = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Identity Registered in Forge');
      navigate('/login');
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6 bg-[radial-gradient(ellipse_at_bottom,rgba(0,97,255,0.05),transparent)]">
      <div className="w-full max-w-[400px] animate-in fade-in slide-in-from-top-8 duration-700">
        <div className="flex flex-col items-center mb-10 text-center">
            ...
            <h1 className="text-lg font-black text-white uppercase tracking-widest leading-none">New Forge Identity</h1>
        ...
        <div className="bg-zinc-900/40 border border-border rounded-2xl p-8 backdrop-blur-xl shadow-2xl relative overflow-hidden group">
          ...
          <form onSubmit={handleRegister} className="space-y-5 relative z-10">
            ...
            <div className="space-y-2">
              <label className="text-[9px] font-black text-zinc-600 uppercase tracking-widest ml-1">Forge Email</label>
              <div className="relative">
